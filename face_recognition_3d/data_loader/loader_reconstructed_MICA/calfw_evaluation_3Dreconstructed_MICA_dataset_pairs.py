...
class CALFW_Evaluation_3D_Reconstructed_MICA_Dataset_Pairs():
    def __init__(self, root, batch_size = 32, npoints = 2900, normalize=True, normal_channel=False, modelnet10=False, cache_size=15000, shuffle=False):
        ...
        all_pairs_paths_label, pos_pair_label, neg_pair_label = TreeCALFW_3DReconstructedMICA().load_all_pairs_samples_from_protocol_file(protocol_file_path, root, file_ext)
    ...
    def _get_item(self, index): 
        if index in self.cache:
            ...
            # # Bernardo
            # print('calfw_evaluation_3Dreconstructed_MICA_dataset_pairs.py: _get_item(): loading file:', fn[1])
            # print('calfw_evaluation_3Dreconstructed_MICA_dataset_pairs.py: _get_item(): loading file:', fn[2])
            # print('label:', cls)
            # print('-------------------------')
