...
class BUPT_Evaluation_3D_Reconstructed_MICA_Dataset_Pairs:
    
    def __init__(self, root, protocol_file_path, npoints = 2900, normal_channel=False, batch_size = 32, normalize=True, cache_size=15000):
        self.root = root
        ...
        all_pairs_paths_label, pos_pair_label, neg_pair_label = TreeBUPT_3DReconstructedMICA().load_all_pairs_samples_from_protocol_file(protocol_file_path, root, file_ext)
