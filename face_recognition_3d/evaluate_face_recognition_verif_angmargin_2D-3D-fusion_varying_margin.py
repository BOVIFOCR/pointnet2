...
# parser.add_argument('--model_path', default='logs_training/classification/dataset=reconst_mica_ms1mv2_10000subj_model=pointnet2_cls_ssg_angmargin_max_epoch=100_lr-init=5e-05_moment=0.9_loss=arcface_s=32_m=0.0_26052023_222414/model_best_train_accuracy.ckpt', help='model checkpoint file path')  # Bernardo
# parser.add_argument('--model_path', default='logs_training/classification/dataset=reconst_mica_ms1mv2_10000subj_model=pointnet2_cls_ssg_angmargin_max_epoch=100_lr-init=5e-05_moment=0.9_loss=arcface_s=32_m=0.0_06062023_190300/model_best_train_accuracy.ckpt', help='model checkpoint file path')  # Bernardo
>>>>>>> Stashed changes
...
<<<<<<< Updated upstream
=======
# ARCFACE_DISTANCES_FILE = '/home/bjgbiesseck/GitHub/InsightFace-tensorflow_BKP-DUO/output/dataset=MS1MV3_classes=10000_backbone=resnet_v2_m_50_epoch-num=200_loss=arcface_s=64.0_m=0.5_moment=0.9_batch=64_lr-init=0.005_20230522-100202/lfw_distances_arcface=10000class_acc=0.98583.npy'
>>>>>>> Stashed changes
